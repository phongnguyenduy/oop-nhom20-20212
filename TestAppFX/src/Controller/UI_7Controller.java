...
public class UI_7Controller implements Initializable{
    @FXML
    ...
    public void setSearchButton(ActionEvent event){
        ...
        url = url + s.substring(j, s.length()) + "&aqs=chrome.0.69i59j46i275j0l3j69i61l3.2845j0j4&sourceid=chrome&ie=UTF-8";
